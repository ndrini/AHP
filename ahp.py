...
class Ahp():
    ...
    def componi_matrice(self, giud=["a", "b", "c", "e"], g_c_half=['8', '7', '9', '7', '8', '7']):
        ...
        # initialize the matrix as a list of list
        matrice = [[] for x in range(l)]
        # print("First version of the matrix:\n", matrice
        # initialize the matrix with lower and diagonal values
        for j_r in range(l):
            # # print(j_r
            for j_c in range(l):
                if j_c < j_r:
